% -------------------------------------------------------------------------
% This function outputs the Histogram of Oriented Optical Flow 
% Inputs are the X and Y direction flows
% Adapted from the HOOF Code by Rizwan Chaudhry, Avinash Ravichandran - JHU Vision Lab
% -------------------------------------------------------------------------
function hoof = histogramOfGradients(Fx,Fy)

configPB = loadConfiguration(); 
binSize = configPB.histBinSize; 
